    ...
    <form id="eab-checkout-form" class="eab-checkout-form">
        <div class="eab-checkout-lines">
            <?php foreach ($items as $item) :
                ...
                ?>
                <section class="eab-checkout-line" data-post-id="<?php echo esc_attr($post_id); ?>">
                    <header class="eab-checkout-line__header">
                        <h3>
                    ...
                    <div class="eab-checkout-attendees" data-post-id="<?php echo esc_attr($post_id); ?>"
                    ...
                    <p class="eab-checkout-line__total">
                        <?php esc_html_e('Cena řádku:', 'events-and-bookings'); ?>
        ...
        <p class="eab-checkout-grand-total">
            <?php esc_html_e('Celkem:', 'events-and-bookings'); ?>
        ...
        <?php if ($terms_page) : ?>
            <label class="eab-checkbox">
                ...
                <span>
                    <?php
                    printf(
                        wp_kses_post(__('Souhlasím s <a href="%s" target="_blank" rel="noopener">obchodními podmínkami</a>', 'events-and-bookings')),
